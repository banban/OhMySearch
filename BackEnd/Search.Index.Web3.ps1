...
function Main(){
    ...
    $siteUrl = "https://intranet.novagroup.com.au/bms/wiki" 

    $username =  "Nova\Andrew.Butenko" 
    ...
    $rootWeb = $ctx.Web  
    $sites  = $rootWeb.Webs 
    #$templates = $rootWeb.GetAvailableWebTemplates(1033,1)
    ...
    $spWeb = Get-SPWeb -Identity https://intranet.novagroup.com.au 
