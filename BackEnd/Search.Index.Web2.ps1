...
Test 1. Do not download new files, just process existings:
    .\Search.Index.Web2.ps1 -rootPath "C:\Search\Import\Aircraft" -mask "acrftreg.csv" -delimeter "," -keyFieldName "Serial" -indexName "aircraft_v1" -aliasName "aircraft" -typeName "casa" -newIndex

 2 records rejected
    _type: casa; _id: 1040; error: mapper_parsing_exception; reason: failed to parse [Manu]; status: 400
    _type: casa; _id: 1020; error: mapper_parsing_exception; reason: failed to parse [Manu]; status: 400

Test 2. Adjust type mapping:
    .\Search.Index.Web2.ps1 -rootPath "C:\Search\Import\Aircraft" -mask "acrftreg.csv" -delimeter "," -indexName "aircraft_v1" -aliasName "aircraft" -typeName "casa" -newIndex `
       -typeMapping '{"aircraft_v1":{"mappings":{"casa":{"dynamic":"true","properties":{"Airframe":{"type":"text","fielddata":true},"CoAcata":{"type":"text","fielddata":true}
        ,"CoAcatb":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}},"CoAcatc":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}}
        ,"Countrymanu":{"type":"text","fielddata":true},"Datefirstreg":{"type":"date"},"Engmanu":{"type":"text","fielddata":true},"Engmodel":{"type":"text","fielddata":true}
        ,"Engtype":{"type":"text","fielddata":true},"Fueltype":{"type":"text","fielddata":true},"ICAOtypedesig":{"type":"text","fielddata":true},"MTOW":{"type":"text","fielddata":true}
        ,"Manu":{"type":"text","fielddata":true},"Mark":{"type":"text","fielddata":true},"Model":{"type":"text","fielddata":true},"Propmanu":{"type":"text","fielddata":true}
        ,"Propmodel":{"type":"text","fielddata":true},"Regexpirydate":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}},"Serial":{"type":"text","fielddata":true}
        ,"Type":{"type":"text","fielddata":true},"Typecert":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}},"Yearmanu":{"type":"text","fielddata":true}
        ,"engnum":{"type":"text","fielddata":true},"gear":{"type":"text","fielddata":true},"regType":{"type":"text","fielddata":true},"regholdCommdate":{"type":"date"}
        ,"regholdCountry":{"type":"text","fielddata":true},"regholdPostcode":{"type":"text","fielddata":true},"regholdState":{"type":"text","fielddata":true}
        ,"regholdSuburb":{"type":"text","fielddata":true},"regholdadd1":{"type":"text","fielddata":true},"regholdadd2":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}}
        ,"regholdname":{"type":"text","fielddata":true},"regopCommdate":{"type":"date"},"regopCountry":{"type":"text","fielddata":true},"regopName":{"type":"text","fielddata":true}
        ,"regopPostcode":{"type":"text","fielddata":true},"regopState":{"type":"text","fielddata":true},"regopSuburb":{"type":"text","fielddata":true},"regopadd1":{"type":"text","fielddata":true}
        ,"regopadd2":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}},"suspenddate":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}}
        ,"suspendstatus":{"type":"text","fields":{"keyword":{"type":"keyword","ignore_above":256}}}}}}}}'

Full load test with all types:
 CASA load 
    .\Search.Index.Web2.ps1 -url "http://www.casa.gov.au/wcmswr/_assets/main/casadata/register/data/acrftreg.zip" `
        -rootPath "C:\Search\Import\Aircraft" -mask "acrftreg.csv" -delimeter "," -indexName "aircraft_v1" -aliasName "aircraft" -typeName "casa" -newIndex `
 PNG load
    .\Search.Index.Web2.ps1 -url "http://www.casapng.gov.pg/attachments/article/46/PNG_Active%20Aircraft%20Register.pdf" `
        -rootPath "C:\Search\Import\Aircraft" -mask "PNG*Register.pdf" -delimeter "," -keyFieldName "???" -indexName "aircraft_v1" -typeName "png" `
 EASA scrapping
    .\Search.Index.Web2.ps1 -url "http://easa.europa.eu/document-library/type-certificates?search=&date_filter[value][year]=&product[0]=10&product[1]=14&&order=field_easa_display_date&sort=desc&page=" `  #&page=1
        -rootPath "C:\Search\Import\Aircraft" -delimeter "," -keyFieldName "???" -indexName "aircraft_v1" -typeName "easa" `

 FAA scrapping
    .\Search.Index.Web2.ps1 -url "http://rgl.faa.gov/Regulatory_and_Guidance_Library/rgMakeModel.nsf/CurModTCDSNo!OpenView&ExpandView&Count=1000&Start=" `  #&Start=1
        -rootPath "C:\Search\Import\Aircraft" -delimeter "," -keyFieldName "???" -indexName "aircraft_v1" -typeName "faa" `
    ...
    Test your configuration use this command:
        C:\Search\logstash-5.0.0-alpha3\bin\logstash.bat -f "C:\Search\Import\logstash-casa.conf" --config.test_and_exit
