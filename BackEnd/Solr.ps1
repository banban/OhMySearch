...
#java -Dc=library -Drecursive=yes -Ddata=files -jar "C:\Search\solr-5.4.0\example\exampledocs\post.jar" "L:\*.*" #"\\nova\nova-dfs\library\" 
...
java -Dc=library_core -Ddata=files -Drecursive -Dauto=true -jar C:\Search\solr-5.4.0\example\exampledocs\post.jar \\nova\nova-dfs\library\_Instructions\
